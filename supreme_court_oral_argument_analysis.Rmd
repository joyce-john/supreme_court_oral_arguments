...
![data process diagram](assets/diagrams/data_collection_process.jpg)  
...
```{r word count facet by justice, echo = FALSE, warning = FALSE, message = FALSE, results='hide'}
...
```{r words by vote type, echo = FALSE, warning = FALSE, message = FALSE}
...
```{r questions boxplot, echo = FALSE, warning = FALSE, message = FALSE}
...
```{r boxplot interruptions conditioned by vote type, echo = FALSE, warning = FALSE, message = FALSE}
...
```{r afinn vs sentimentr comparison, echo = FALSE, warning = FALSE, message = FALSE}
...
```{r sentiment density by justice, echo = FALSE, warning = FALSE, message = FALSE}
...
```{r sentiment distribution by vote type, echo = FALSE, warning = FALSE, message = FALSE}
...
```{r ginsburg and gorsuch top unigrams by vote type, echo = FALSE, warning = FALSE, message = FALSE}
...
## -----> sort of a roll your own td-idf solution....
...
```{r tf-idf for all justices, echo = FALSE, warning = FALSE, message = FALSE}
...
### TF-IDF for a Single Justice, Conditioned on Vote Type

If we just focus on one justice, and treat their speech before voting **for** and **against** the petitioner as two separate documents, can we identify any terms that unique to their speech based on how they will vote later?  

Let's try it on Chief Justice Roberts, who is often seen as the swing vote:  

```{r tf-idf roberts conditioned on vote type, echo = FALSE, warning = FALSE, message = FALSE}
...
* sentiment behind her words match her beliefs pretty well, especially if the sentiment is extreme  

**JUSTICE KAGAN**  
* she's the only justice who talks *more* when she agrees with you  
* sentiment is negative on average, but especially when she disagrees with you  
...
**JUSTICE GINSBURG**  
* commonly negative in sentiment, but especially when she disagrees with you  
* talks about equality when she agrees with you, talks about government and courts when she doesn't  