...
```{r sentiment density by justice, echo = FALSE, warning = FALSE, message = FALSE, fig.align = 'center'}
...
```{r sentiment distribution by vote type, echo = FALSE, warning = FALSE, message = FALSE, fig.align = 'center'}
...
```{r tf-idf for all justices, echo = FALSE, warning = FALSE, message = FALSE, fig.align = 'center'}
...
```{r tf-idf roberts conditioned on vote type, echo = FALSE, warning = FALSE, message = FALSE, fig.align = 'center', fig.width = 12}
