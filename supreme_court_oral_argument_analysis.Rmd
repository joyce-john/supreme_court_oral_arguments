...
```{r sentiment density by justice, echo = FALSE, warning = FALSE, message = FALSE, fig.align = 'center', fig.height = 10, fig.width = 10}
...
```{r sentiment distribution by vote type, echo = FALSE, warning = FALSE, message = FALSE, fig.align = 'center', fig.height = 10, fig.width = 10}
...
```{r tf-idf for all justices, echo = FALSE, warning = FALSE, message = FALSE, fig.align = 'center', fig.width = 10, fig.height = 10}
...
```{r tf-idf roberts conditioned on vote type, echo = FALSE, warning = FALSE, message = FALSE, fig.align = 'center', fig.width = 12, fig.height = 10}
